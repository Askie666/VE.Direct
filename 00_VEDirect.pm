...
'0xEDD5'=>{"Bezeichnung"=>"Charger_voltage", "ReadingName"=>"Charger_voltage", "Einheit"=>"V", "Skalierung"=>"0.01", "Payloadnibbles"=>"4", "min"=>"", "max"=>"", "Zyklisch"=>"1", "getConfigAll"=>"0", "getValues"=>"Charger_voltage:noArg", "setValues"=>"-", "spezialSetGet"=>"-"},
...
my %TextMapping = (
'V'=>{"BMV"=>{'Register'=>"0xED8B",'scale'=>0.001,'ReName'=>"Battery_voltage", "Einheit"=>"V"}, "MPPT"=>{'Register'=>"-",'scale'=>0.001,'ReName'=>"Battery_voltage", "Einheit"=>"V"}, "Inverter"=>{'Register'=>"0xED8D",'scale'=>0.001,'ReName'=>"-", "Einheit"=>"V"}},
'VS'=>{"BMV"=>{'Register'=>"0xED7D",'scale'=>0.001,'ReName'=>"-", "Einheit"=>"V"}, "MPPT"=>{'Register'=>"-",'scale'=>0,'ReName'=>"-", "Einheit"=>"V"}, "Inverter"=>{'Register'=>"-",'scale'=>0,'ReName'=>"-", "Einheit"=>"V"}},
...
'AR'=>{"BMV"=>{'Register'=>"0x031E",'scale'=>0,'ReName'=>"-"}, "MPPT"=>{'Register'=>"-",'scale'=>0,'ReName'=>"-"}, "Inverter"=>{'Register'=>"-",'scale'=>0,'ReName'=>"-"}},
